...
def readDataFromPixhawk(device, baudrate):
	args = ("./mavlink_control", "-d", device, "-b", baudrate)
	...
	return latitude,longitude,relative_altitude, heading


def geotagPhoto(latitude, longitude, relative_altitude, heading, image_path):
